...
// GenSessionID provides a mock function with given fields:
func (_m *MockSessionStore) GenSessionID() (string, error) {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GenSessionID")
	}
...
// MockSessionStore_GenSessionID_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GenSessionID'
type MockSessionStore_GenSessionID_Call struct {
	*mock.Call
}

// GenSessionID is a helper method to define mock.On call
func (_e *MockSessionStore_Expecter) GenSessionID() *MockSessionStore_GenSessionID_Call {
	return &MockSessionStore_GenSessionID_Call{Call: _e.mock.On("GenSessionID")}
}

func (_c *MockSessionStore_GenSessionID_Call) Run(run func()) *MockSessionStore_GenSessionID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockSessionStore_GenSessionID_Call) Return(_a0 string, _a1 error) *MockSessionStore_GenSessionID_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSessionStore_GenSessionID_Call) RunAndReturn(run func() (string, error)) *MockSessionStore_GenSessionID_Call {
	_c.Call.Return(run)
	return _c
}
