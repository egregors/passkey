...
type MockSessionStore[T interface {
	webauthn.SessionData | UserSessionData
}] struct {
	mock.Mock
}

type MockSessionStore_Expecter[T interface {
	webauthn.SessionData | UserSessionData
}] struct {
	mock *mock.Mock
}
...
type MockSessionStore_Create_Call[T interface {
	webauthn.SessionData | UserSessionData
}] struct {
	*mock.Call
}
...
type MockSessionStore_Delete_Call[T interface {
	webauthn.SessionData | UserSessionData
}] struct {
	*mock.Call
}
...
type MockSessionStore_Get_Call[T interface {
	webauthn.SessionData | UserSessionData
}] struct {
	*mock.Call
}
